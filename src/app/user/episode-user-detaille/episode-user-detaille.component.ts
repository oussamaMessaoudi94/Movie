...
@Component({
  selector: 'app-episode-user-detaille',
  templateUrl: './episode-user-detaille.component.html',
  styleUrls: ['./episode-user-detaille.component.css']
})
export class EpisodeUserDetailleComponent implements OnInit {
  id :any
  ep: any=[]
  serie :any=[]
  movie:any=[]
