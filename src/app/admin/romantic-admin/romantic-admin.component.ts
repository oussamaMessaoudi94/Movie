...
@Component({
  selector: 'app-romantic-admin',
  templateUrl: './romantic-admin.component.html',
  styleUrls: ['./romantic-admin.component.css']
})
export class RomanticAdminComponent implements OnInit {
movie:any=[]
romantic:any=[]
