...
@Component({
  selector: 'app-episode-detai',
  templateUrl: './episode-detai.component.html',
  styleUrls: ['./episode-detai.component.css']
})
export class EpisodeDetaiComponent implements OnInit {
  id :any
  ep: any=[]
  serie :any=[]
  movie:any=[]
